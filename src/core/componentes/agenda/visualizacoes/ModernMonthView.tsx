    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="grid grid-cols-7 border-b border-border bg-muted/30">
        {diasDaSemana.map(dia => (
          <div key={dia} className="p-3 text-center text-sm font-medium text-muted-foreground border-r border-border/30 last:border-r-0">
            {dia}
          </div>
        ))}
      </div>
      ...
      {/* Calendar grid */}
      <div className="flex-1 grid grid-cols-7 gap-0 border-border/50">
...
ModernMonthView.displayName = 'ModernMonthView';

export default ModernMonthView;
...
interface SkeletonDiaIndividualProps {
  tipo: 'month' | 'week' | 'day' | 'agenda';
  quantidadeEventos?: number;
}

const SkeletonDiaIndividual = memo(({ tipo, quantidadeEventos = 2 }: SkeletonDiaIndividualProps) => {
  if (tipo === 'agenda') {
    return (
...
SkeletonDiaIndividual.displayName = 'SkeletonDiaIndividual';

export default SkeletonDiaIndividual;

...
interface SkeletonDiaDiarioProps {
  timeSlots?: number;
  hasEvents?: boolean;
}

const SkeletonDiaDiario = memo(({ 
  timeSlots = 12, 
  hasEvents = true 
}: SkeletonDiaDiarioProps) => {
  return (
...
SkeletonDiaDiario.displayName = 'SkeletonDiaDiario';

export default SkeletonDiaDiario;
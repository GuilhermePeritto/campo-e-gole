...
const Revenues = () => {
  ...
  const filteredRevenues = mockRevenues.filter(revenue => {
      ...
      <header className="shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Button onClick={() => navigate('/financeiro/nova-receita')} className="gap-2">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{filteredRevenues.filter(r => r.status === 'Recebido').length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-600">{filteredRevenues.filter(r => r.status === 'Pendente').length}</p>
                </div>
              </div>
            </CardContent>
          </Card>

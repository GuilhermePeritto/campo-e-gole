    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-4 h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-medium text-black">Novo Local</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <Card className="border-gray-200">
          <CardHeader>
            <CardTitle className="text-black">Cadastrar Local</CardTitle>
            <CardDescription className="text-gray-600">
              Preencha as informações do novo local
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="Descrição adicional do local (ex: Quadra de grama sintética com marcações para futsal e society)"

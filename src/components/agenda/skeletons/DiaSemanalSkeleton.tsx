...
interface DiaSemanalSkeletonProps {
  hasEvents?: boolean;
  eventCount?: number;
}

const DiaSemanalSkeleton = memo(({ 
  hasEvents = false, 
  eventCount = 1 
}: DiaSemanalSkeletonProps) => {
  return (
...
DiaSemanalSkeleton.displayName = 'DiaSemanalSkeleton';

export default DiaSemanalSkeleton;
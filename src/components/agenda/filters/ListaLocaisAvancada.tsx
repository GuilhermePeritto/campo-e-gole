...
const ListaLocaisAvancada = memo(({ 
  ...
  return (
    <div className={cn("flex flex-col h-full max-h-[calc(100vh-200px)] min-h-0", className)}>
      {/* Cabeçalho - Fixo */}
      ...
      {/* Lista de locais - Scrollável */}
      <div className="flex-1 min-h-0 overflow-hidden">
        <div className="bg-gradient-to-br from-card/80 to-card/40 rounded-lg border border-border/50 shadow-sm h-full flex flex-col">
          {/* Opção "Todos os locais" - Fixo */}

...
const CalendarViews = ({
  ...
  console.log('CalendarViews - selectedVenue:', selectedVenue);
  console.log('CalendarViews - mockReservations:', mockReservations);
  console.log('CalendarViews - filteredReservations:', filteredReservations);
